	...
	return (
		...
		>
			<div className='p-8'>
				...
				<form onSubmit={handleSignUp}>
					<div className="relative">
						<select
							className="w-full p-3 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 mb-4"
							value={organizationName}
							onChange={(e) => {
								console.log("Selected organization:", e.target.value); // Debug log
			...
			<div className='px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-between'>
				...
				<Link to='/admin/signup' className='text-sm text-green-400 hover:underline'>
